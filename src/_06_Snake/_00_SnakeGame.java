...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Don't hit yourself or the walls";
	...
	private void setFoodLocation() {
		...
		int loc1 = rand.nextInt(15);
		int loc2 = rand.nextInt(12);
		Location randL = new Location(loc1, loc2);
		...
		while(snake.isLocationOnSnake(randL)) {
			loc1 = rand.nextInt(15);
			loc2 = rand.nextInt(12);
			randL = new Location(loc1, loc2);
		}
			foodLocation = randL;
	}
	...
	private void gameOver() {
		...
		//   else, exit the game
		if(reset == 0) {
			Location newLoc = new Location(WIDTH / 2, HEIGHT / 2);
			snake.reset(newLoc);
			setFoodLocation();
			timer.start();
		}
